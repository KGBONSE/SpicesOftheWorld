# Episode 2 — Senegal: Jollof's Birthplace & the Smoky Secret of Grains of Selim

Continues straight on from Episode 1 — grains of selim shows up again, this
time from Senegal's side of its story, and jollof rice (which picked up
Ghana/Nigeria's grains of paradise and grains of selim once it travelled
east) gets its actual origin story told. Grounded entirely in
`knowledge-base/regional/africa-spice-notes.md` (West Africa section) and
...
**[ON-SCREEN TEXT]:** "Jollof rice — born in Senegal"
**[B-ROLL]:** Map graphic, Senegal coastline/market footage
...
Middle Ages as a cheaper stand-in for black pepper, until the Portuguese
...
But here's the part that's specific to Senegal — the pods are
traditionally smoked during drying there, and that's what gives them their
distinctive musky, wood-smoke aroma. Most of that smokiness sits right in
...
**[ON-SCREEN TEXT]:** "YASSA: mustard + onion + garlic + lemon/vinegar"
**[B-ROLL]:** Marinade being mixed, onions caramelising

*(Note: the source gives the flavour profile, not exact measurements —
same as the Yaji blend last episode. Worth test-cooking before filming.)*
...
**[ON-SCREEN TEXT]:** "POULET YASSA"
**[B-ROLL]:** Grilling/braising footage, finished plate
...
**[ON-SCREEN TEXT]:** "Spices of Africa — one journey, still moving"

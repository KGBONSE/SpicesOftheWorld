# Episode 4 — Sierra Leone & Liberia: Pepper Soup, Uda & Dumboy

Not in your knowledge base at all — this one is grounded in general web
research instead of *The Science of Spice* or your own knowledge. Flagged
clearly below wherever a fact comes from that research rather than the
book. Sources at the bottom.
...
— it wasn't shaped by European colonial trade the same way. It was founded
in the 19th century by freed African-American settlers returning to West
...
**[ON-SCREEN TEXT]:** "Liberia — founded by freed African-American settlers, 19th century"
**[B-ROLL]:** Map graphic
...
— our spice from episode one, the one behind Yaji — shows up here again
under a different name: uda, or negro pepper. Same plant, same fenchone
musk, just a different country's name for it.

**[ON-SCREEN TEXT]:** "Grains of selim = uda = negro pepper — same spice, different name"
**[B-ROLL]:** Trade route map animation

## 4. The Science

Sierra Leone's pepper soup leans on that same grains-of-selim muskiness we
already know, but pairs it with something new here — calabash nutmeg,
which brings a bitter, almost medicinal edge to the broth. Between the
...
country onion — a small, intensely flavoured wild onion — and often uda
and calabash nutmeg alongside it, all simmered together with goat, fish,
or chicken.

**[ON-SCREEN TEXT]:** "PEPPER SOUP SPICE: Scotch bonnet + garlic + ginger + country onion + uda + calabash nutmeg"
**[B-ROLL]:** Ingredients laid out, broth simmering

*(Note: this recipe comes from general research, not the book or your own
knowledge — worth double-checking against a Sierra Leonean source or
contact before filming.)*
...
side dish, more a whole way of eating together.

**[ON-SCREEN TEXT]:** "DUMBOY — pounded cassava, eaten communally"
**[B-ROLL]:** Pounding cassava, communal eating shot
...
carrying Ghana's spices to a farm in London and building Fudi People out
of it.

**[ON-SCREEN TEXT]:** "One spice, the whole coast."
...
Full draft, ready to read/shoot except the hook. **Unlike every other
episode so far, none of this is sourced from `knowledge-base/` or from
Kofi directly** — it's general web research, so it should be treated as a
starting point to verify rather than a locked fact set. Worth checking
...
- [FunTimes Magazine — Traditional Sierra Leone Pepper Soup](https://funtimesmagazine.com/recipes/sierra-leone-pepper-soup/)
- [Sierra Leone Tourism — Traditional Dishes](https://tourismsierraleone.com/stories/traditional-dishes-savouring-sierra-leone/)

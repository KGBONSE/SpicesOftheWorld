# Episode 7 — Central Africa: Mbongo, Njangsa & Calabash Nutmeg

The heaviest history in the series so far — a direct thread into the
transatlantic slave trade. Handle the close with real weight, not a neat
bow. Grounded in `knowledge-base/regional/africa-spice-notes.md` (Central
Africa section) and the (true) Nutmeg profile in
...
one exception, introduced by Portuguese explorers in the 15th century,
same story as episode one.

**[ON-SCREEN TEXT]:** "Bobimbi, njangsa, mbongo — spices you won't find in most spice books"
**[B-ROLL]:** Map graphic
...
through the European slave trade, where it became known as Jamaican
nutmeg. I'm not going to soften that. That's the actual route this spice
took.

**[ON-SCREEN TEXT]:** "Calabash nutmeg → the Caribbean, via the slave trade → 'Jamaican nutmeg'"
**[B-ROLL]:** Historical map, handled with restraint — no upbeat music here
...
chemistry is a good reference point — myristicin gives it that woody
aroma, eugenol and cineole add clove-like, eucalyptus notes. There's even
a compound in there, discovered fairly recently, that triggers a numbing,
...
**[ON-SCREEN TEXT]:** "MBONGO MIX: mbongo + bobimbi + njangsa + calabash nutmeg + grains of paradise + garlic + onion"
**[B-ROLL]:** Grinding spices, close-up texture shots

*(Note: several ingredients here have listed substitutes for accessibility
— black cardamom for mbongo, wild garlic or regular garlic for bobimbi,
peanuts for njangsa. No exact quantities given in the source.)*
...
**[ON-SCREEN TEXT]:** "MBONGO TCHOBI — Cameroon's 'black stew'"
**[B-ROLL]:** Stew simmering, finished dish
...
skip it just because it's heavier than the rest of this series. It's
exactly why telling these stories properly matters to me — not just the
flavour, the whole truth of how it got here.

**[ON-SCREEN TEXT]:** "Not every spice route was chosen. This one matters too."
**[B-ROLL]:** Quiet, restrained — Sidcup farm footage, no upbeat close
